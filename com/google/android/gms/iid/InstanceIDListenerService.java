...
public class InstanceIDListenerService extends Service {
    ...
    class C07771 extends Handler {
        final /* synthetic */ InstanceIDListenerService zzbhn;

        C07771(InstanceIDListenerService instanceIDListenerService, Looper looper) {
    ...
    class C07782 extends BroadcastReceiver {
        final /* synthetic */ InstanceIDListenerService zzbhn;

        C07782(InstanceIDListenerService instanceIDListenerService) {
            this.zzbhn = instanceIDListenerService;
        }
    ...
    public InstanceIDListenerService() {
        this.zzbhh = new MessengerCompat(new C07771(this, Looper.getMainLooper()));
        this.zzbhi = new C07782(this);
    }
