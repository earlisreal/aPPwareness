...
public final class zzh {
    ...
    class C04581 implements Runnable {
        ...
        C04581(zzh com_google_android_gms_analytics_zzh, zze com_google_android_gms_analytics_zze) {
    ...
    private class zza extends ThreadPoolExecutor {
        ...
        class C04591 extends FutureTask<T> {
            final /* synthetic */ zza zzabo;

            C04591(zza com_google_android_gms_analytics_zzh_zza, Runnable runnable, Object obj) {
        ...
        protected <T> RunnableFuture<T> newTaskFor(Runnable runnable, T t) {
            return new C04591(this, runnable, t);
        }
    }
    ...
    void zze(zze com_google_android_gms_analytics_zze) {
        if (com_google_android_gms_analytics_zze.zzmk()) {
            ...
            zzmb.zzmh();
            this.zzabj.execute(new C04581(this, zzmb));
        }
    }
