...
public class zze extends zza implements ServiceConnection {
    ...
    public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        ...
        try {
            ...
            this.mActivity.startIntentSenderForResult(pendingIntent.getIntentSender(), LocationStatusCodes.GEOFENCE_TOO_MANY_GEOFENCES, new Intent(), Integer.valueOf(0).intValue(), Integer.valueOf(0).intValue(), Integer.valueOf(0).intValue());
