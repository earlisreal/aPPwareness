...
public class zzu extends com.google.android.gms.internal.zzep.zza {
    ...
    class C04481 extends WebViewClient {
        ...
        C04481(zzu com_google_android_gms_ads_internal_zzu) {
    ...
    class C04492 implements OnTouchListener {
        final /* synthetic */ zzu zzus;

        C04492(zzu com_google_android_gms_ads_internal_zzu) {
            this.zzus = com_google_android_gms_ads_internal_zzu;
        }
    ...
    class C04503 implements Callable<zzch> {
        final /* synthetic */ zzu zzus;

        C04503(zzu com_google_android_gms_ads_internal_zzu) {
            this.zzus = com_google_android_gms_ads_internal_zzu;
        }
    ...
    private void zzcw() {
        ...
        this.zzup.setWebViewClient(new C04481(this));
        this.zzup.setOnTouchListener(new C04492(this));
    }

    private Future<zzch> zzcz() {
        return zzph.zza(new C04503(this));
    }
