...
public class zzz {
    ...
    public zzz(Context context, zzqa com_google_android_gms_internal_zzqa, String str, @Nullable zzgf com_google_android_gms_internal_zzgf, @Nullable zzgd com_google_android_gms_internal_zzgd) {
        this.zzOp = new zzb().zza("min_1", Double.MIN_VALUE, 1.0d).zza("1_5", 1.0d, 5.0d).zza("5_10", 5.0d, 10.0d).zza("10_20", 10.0d, 20.0d).zza("20_30", 20.0d, 30.0d).zza("30_max", 30.0d, Double.MAX_VALUE).zzkB();
        this.zzOs = false;
        this.zzOt = false;
        this.zzOu = false;
        this.zzOv = false;
    ...
    String zza(TextureView textureView) {
        ...
        while (i < 8) {
            ...
            for (int i2 = 0; i2 < 8; i2++) {
                ...
                j3 |= (Color.green(pixel) + (Color.blue(pixel) + Color.red(pixel)) > Cast.MAX_NAMESPACE_LENGTH ? 1 : 0) << ((int) j);
                j--;
            }
            i++;
            j2 = j;
