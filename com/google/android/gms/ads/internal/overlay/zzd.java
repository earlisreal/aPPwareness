...
public class zzd extends zzj implements OnBufferingUpdateListener, OnCompletionListener, OnErrorListener, OnInfoListener, OnPreparedListener, OnVideoSizeChangedListener, SurfaceTextureListener {
    ...
    class C04031 implements Runnable {
        ...
        C04031(zzd com_google_android_gms_ads_internal_overlay_zzd) {
    ...
    class C04042 implements Runnable {
        ...
        C04042(zzd com_google_android_gms_ads_internal_overlay_zzd) {
            this.zzMs = com_google_android_gms_ads_internal_overlay_zzd;
        }
    ...
    class C04053 implements Runnable {
        final /* synthetic */ zzd zzMs;
        final /* synthetic */ String zzMt;
        final /* synthetic */ String zzMu;

        C04053(zzd com_google_android_gms_ads_internal_overlay_zzd, String str, String str2) {
            this.zzMs = com_google_android_gms_ads_internal_overlay_zzd;
            this.zzMt = str;
            this.zzMu = str2;
        }
    ...
    class C04064 implements Runnable {
        ...
        C04064(zzd com_google_android_gms_ads_internal_overlay_zzd) {
            this.zzMs = com_google_android_gms_ads_internal_overlay_zzd;
        }
    ...
    class C04075 implements Runnable {
        final /* synthetic */ zzd zzMs;
        final /* synthetic */ int zzMv;
        final /* synthetic */ int zzMw;

        C04075(zzd com_google_android_gms_ads_internal_overlay_zzd, int i, int i2) {
            this.zzMs = com_google_android_gms_ads_internal_overlay_zzd;
            this.zzMv = i;
            this.zzMw = i2;
        }
    ...
    class C04086 implements Runnable {
        final /* synthetic */ zzd zzMs;

        C04086(zzd com_google_android_gms_ads_internal_overlay_zzd) {
            this.zzMs = com_google_android_gms_ads_internal_overlay_zzd;
        }
    ...
    class C04097 implements Runnable {
        final /* synthetic */ zzd zzMs;

        C04097(zzd com_google_android_gms_ads_internal_overlay_zzd) {
            this.zzMs = com_google_android_gms_ads_internal_overlay_zzd;
        }
    ...
    class C04108 implements Runnable {
        ...
        C04108(zzd com_google_android_gms_ads_internal_overlay_zzd) {
            this.zzMs = com_google_android_gms_ads_internal_overlay_zzd;
        }
    ...
    private void zzhe() {
        Throwable e;
        String valueOf;
        zzpe.m29v("AdMediaPlayerView init MediaPlayer");
    ...
    private void zzhf() {
        if (this.zzMe && zzhg() && this.zzMh.getCurrentPosition() > 0 && this.zzMg != 3) {
            zzpe.m29v("AdMediaPlayerView nudging MediaPlayer");
            zza(0.0f);
            this.zzMh.start();
    ...
    private void zzy(boolean z) {
        zzpe.m29v("AdMediaPlayerView release");
        if (this.zzMo != null) {
            this.zzMo.zzhP();
            this.zzMo = null;
        }
    ...
    public void onCompletion(MediaPlayer mediaPlayer) {
        zzpe.m29v("AdMediaPlayerView completion");
        zzI(5);
        zzJ(5);
        zzpi.zzWR.post(new C04042(this));
    }
    ...
    public boolean onError(MediaPlayer mediaPlayer, int i, int i2) {
        ...
        zzI(-1);
        zzJ(-1);
        zzpi.zzWR.post(new C04053(this, str, str2));
        return true;
    }
    ...
    public boolean onInfo(MediaPlayer mediaPlayer, int i, int i2) {
        String str = (String) zzMc.get(Integer.valueOf(i));
        String str2 = (String) zzMc.get(Integer.valueOf(i2));
        zzpe.m29v(new StringBuilder((String.valueOf(str).length() + 37) + String.valueOf(str2).length()).append("AdMediaPlayerView MediaPlayer info: ").append(str).append(":").append(str2).toString());
        return true;
    }
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        zzpe.m29v("AdMediaPlayerView prepared");
        zzI(2);
        this.zzMd.zzhz();
        zzpi.zzWR.post(new C04031(this));
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
        zzpe.m29v("AdMediaPlayerView surface created");
        zzhe();
        zzpi.zzWR.post(new C04064(this));
    }

    public boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
        zzpe.m29v("AdMediaPlayerView surface destroyed");
        ...
        zzpi.zzWR.post(new C04086(this));
        zzy(true);
        return true;
    }
    ...
    public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i2) {
        Object obj = 1;
        zzpe.m29v("AdMediaPlayerView surface changed");
        ...
        zzpi.zzWR.post(new C04075(this, i, i2));
    }
    ...
    public void onVideoSizeChanged(MediaPlayer mediaPlayer, int i, int i2) {
        zzpe.m29v("AdMediaPlayerView size changed: " + i + " x " + i2);
        this.zzMj = mediaPlayer.getVideoWidth();
        this.zzMk = mediaPlayer.getVideoHeight();
    ...
    public void pause() {
        zzpe.m29v("AdMediaPlayerView pause");
        if (zzhg() && this.zzMh.isPlaying()) {
            this.zzMh.pause();
            zzI(4);
            zzpi.zzWR.post(new C04108(this));
        }
        zzJ(4);
    }

    public void play() {
        zzpe.m29v("AdMediaPlayerView play");
        if (zzhg()) {
            this.zzMh.start();
            zzI(3);
            this.zzNj.zzhA();
            zzpi.zzWR.post(new C04097(this));
        }
        zzJ(3);
    }

    public void seekTo(int i) {
        zzpe.m29v("AdMediaPlayerView seek " + i);
        if (zzhg()) {
            this.zzMh.seekTo(i);
            this.zzMq = 0;
            return;
    ...
    public void stop() {
        zzpe.m29v("AdMediaPlayerView stop");
        if (this.zzMh != null) {
            this.zzMh.stop();
            this.zzMh.release();
            this.zzMh = null;
