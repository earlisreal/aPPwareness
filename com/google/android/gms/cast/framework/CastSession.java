...
public class CastSession extends Session {
    ...
    private final Set<Listener> zzapf;
    ...
    public double getVolume() throws IllegalStateException {
        zzac.zzdn("Must be called from the main thread.");
        return this.zzamy != null ? this.zzaph.getVolume(this.zzamy) : 0.0d;
    }
    ...
    public PendingResult<Status> sendMessage(String str, String str2) {
        zzac.zzdn("Must be called from the main thread.");
        return this.zzamy != null ? this.zzaph.sendMessage(this.zzamy, str, str2) : null;
    }
