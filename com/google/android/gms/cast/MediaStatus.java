...
public final class MediaStatus extends zza {
    ...
    public static final Creator<MediaStatus> CREATOR;
    ...
    public MediaStatus(JSONObject jSONObject) throws JSONException {
        this(REPEAT_MODE_REPEAT_SINGLE, null, 0, REPEAT_MODE_REPEAT_OFF, 0.0d, REPEAT_MODE_REPEAT_OFF, REPEAT_MODE_REPEAT_OFF, 0, 0, 0.0d, false, null, REPEAT_MODE_REPEAT_OFF, REPEAT_MODE_REPEAT_OFF, null, REPEAT_MODE_REPEAT_OFF, null, false, null, null);
        zza(jSONObject, REPEAT_MODE_REPEAT_OFF);
    }

    private void zza(MediaQueueItem[] mediaQueueItemArr) {
        this.zzanM.clear();
        this.zzanQ.clear();
        for (int i = REPEAT_MODE_REPEAT_OFF; i < mediaQueueItemArr.length; i += REPEAT_MODE_REPEAT_ALL) {
    ...
    private boolean zzf(int i, int i2, int i3, int i4) {
        if (i != REPEAT_MODE_REPEAT_ALL) {
            return false;
        }
        switch (i2) {
            case REPEAT_MODE_REPEAT_ALL /*1*/:
            case REPEAT_MODE_REPEAT_ALL_AND_SHUFFLE /*3*/:
                return i3 == 0;
            case REPEAT_MODE_REPEAT_SINGLE /*2*/:
                return i4 != REPEAT_MODE_REPEAT_SINGLE;
            default:
                return true;
        }
    }
    ...
    private void zzsb() {
        this.zzanL = REPEAT_MODE_REPEAT_OFF;
        this.zzanM.clear();
        this.zzanQ.clear();
    }
    ...
    public AdBreakInfo getCurrentAdBreak() {
        ...
        Object breakId = this.zzanO.getBreakId();
    ...
    public MediaQueueItem getItemByIndex(int i) {
        return (i < 0 || i >= this.zzanM.size()) ? null : (MediaQueueItem) this.zzanM.get(i);
    }
    ...
    public int zza(JSONObject jSONObject, int i) throws JSONException {
        ...
        if (jSONObject.has("activeTrackIds")) {
            ...
            if (this.zzany == null) {
                ...
                z = REPEAT_MODE_REPEAT_OFF;
            }
            if (z) {
                this.zzany = jArr;
            }
        } else {
            z = this.zzany != null ? true : REPEAT_MODE_REPEAT_OFF;
        }
        if (z) {
            this.zzany = jArr;
            i2 |= REPEAT_MODE_REPEAT_SINGLE;
        ...
        i3 = jSONObject.optInt("preloadedItemId", REPEAT_MODE_REPEAT_OFF);
        if (this.zzanK != i3) {
            this.zzanK = i3;
            i2 |= 16;
        }
        i3 = jSONObject.optInt("loadingItemId", REPEAT_MODE_REPEAT_OFF);
        if (this.zzanJ != i3) {
            this.zzanJ = i3;
            i2 |= REPEAT_MODE_REPEAT_SINGLE;
        }
        if (zzf(this.zzanD, this.zzanE, this.zzanJ, this.zzank == null ? -1 : this.zzank.getStreamType())) {
            this.zzanB = REPEAT_MODE_REPEAT_OFF;
            this.zzanJ = REPEAT_MODE_REPEAT_OFF;
            this.zzanK = REPEAT_MODE_REPEAT_OFF;
