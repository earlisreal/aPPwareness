...
public class MediaQueueItem extends zza {
    public static final Creator<MediaQueueItem> CREATOR;
    ...
    public static class Builder {
        ...
        public Builder(MediaInfo mediaInfo) throws IllegalArgumentException {
            this.zzanz = new MediaQueueItem(null);
        }
    ...
    private MediaQueueItem(MediaInfo mediaInfo) throws IllegalArgumentException {
        this(1, mediaInfo, 0, true, 0.0d, DEFAULT_PLAYBACK_DURATION, 0.0d, null, null);
        if (mediaInfo == null) {
    ...
    MediaQueueItem(JSONObject jSONObject) throws JSONException {
        this(1, null, 0, true, 0.0d, DEFAULT_PLAYBACK_DURATION, 0.0d, null, null);
        zzo(jSONObject);
    }
    ...
    public JSONObject toJson() {
        ...
        try {
            ...
            if (this.zzanw != DEFAULT_PLAYBACK_DURATION) {
