...
public class zzab {
    ...
    class C05472 implements com.google.android.gms.common.api.PendingResult.zza {
        ...
        C05472(PendingResult pendingResult, TaskCompletionSource taskCompletionSource, zza com_google_android_gms_common_internal_zzab_zza, zzb com_google_android_gms_common_internal_zzab_zzb) {
    ...
    class C05483 implements zza<R, T> {
        final /* synthetic */ zze zzaFe;

        C05483(zze com_google_android_gms_common_api_zze) {
    ...
    public static <R extends Result, T extends zze<R>> Task<T> zza(PendingResult<R> pendingResult, T t) {
        return zza((PendingResult) pendingResult, new C05483(t));
    }
    ...
    public static <R extends Result, T> Task<T> zza(PendingResult<R> pendingResult, zza<R, T> com_google_android_gms_common_internal_zzab_zza_R__T, zzb com_google_android_gms_common_internal_zzab_zzb) {
        ...
        pendingResult.zza(new C05472(pendingResult, taskCompletionSource, com_google_android_gms_common_internal_zzab_zza_R__T, com_google_android_gms_common_internal_zzab_zzb));
