...
public interface Quests {
    ...
    static {
        SELECT_ALL_QUESTS = new int[]{SORT_ORDER_ENDING_SOON_FIRST, SELECT_OPEN, SELECT_ACCEPTED, SELECT_COMPLETED, SELECT_COMPLETED_UNCLAIMED, SELECT_EXPIRED, SELECT_ENDING_SOON, SELECT_FAILED, SELECT_RECENTLY_FAILED};
    }
