...
public class zzayi {
    ...
    public long zzQn() {
        return Math.max(0, zzOP().getLong("FORBIDDEN_COUNT", 0)) == 0 ? 0 : zzg(NotificationOptions.SKIP_STEP_TEN_SECONDS_IN_MS, 600000) + NotificationOptions.SKIP_STEP_TEN_SECONDS_IN_MS;
    }
