...
public final class zzme {
    ...
    class C14281 implements zzb {
        final /* synthetic */ Context zztd;

        C14281(Context context) {
            this.zztd = context;
        }
    ...
    public static zzpk zza(Context context, zzqa com_google_android_gms_internal_zzqa, zzqi<zzmh> com_google_android_gms_internal_zzqi_com_google_android_gms_internal_zzmh, zza com_google_android_gms_internal_zzme_zza) {
        return zza(context, com_google_android_gms_internal_zzqa, com_google_android_gms_internal_zzqi_com_google_android_gms_internal_zzmh, com_google_android_gms_internal_zzme_zza, new C14281(context));
    }
