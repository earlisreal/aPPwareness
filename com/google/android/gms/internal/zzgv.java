...
public class zzgv implements zzgu {
    ...
    class C13011 extends zzlt.zza {
        final /* synthetic */ JSONObject zzGx;

        C13011(zzgv com_google_android_gms_internal_zzgv, JSONObject jSONObject) {
            this.zzGx = jSONObject;
        }

        public void zze(zzjb com_google_android_gms_internal_zzjb) {
            com_google_android_gms_internal_zzjb.zza("google.afma.nativeAds.handleClickGmsg", this.zzGx);
        }
    }

    /* renamed from: com.google.android.gms.internal.zzgv.2 */
    class C13022 extends zzlt.zza {
        final /* synthetic */ JSONObject zzGx;

        C13022(zzgv com_google_android_gms_internal_zzgv, JSONObject jSONObject) {
            this.zzGx = jSONObject;
        }

        public void zze(zzjb com_google_android_gms_internal_zzjb) {
            com_google_android_gms_internal_zzjb.zza("google.afma.nativeAds.handleImpressionPing", this.zzGx);
        }
    }

    /* renamed from: com.google.android.gms.internal.zzgv.3 */
    class C13093 extends zzlt.zza {
        final /* synthetic */ zzgv zzGy;

        /* renamed from: com.google.android.gms.internal.zzgv.3.1 */
        class C13041 implements zzhx {
            final /* synthetic */ C13093 zzGA;
            final /* synthetic */ zzjb zzGz;

            /* renamed from: com.google.android.gms.internal.zzgv.3.1.1 */
            class C13031 implements zzqq.zza {
                final /* synthetic */ Map zzGB;
                final /* synthetic */ C13041 zzGC;

                C13031(C13041 c13041, Map map) {
                    this.zzGC = c13041;
                    this.zzGB = map;
                }

                public void zza(zzqp com_google_android_gms_internal_zzqp, boolean z) {
                    this.zzGC.zzGA.zzGy.zzGu = (String) this.zzGB.get("id");
                    JSONObject jSONObject = new JSONObject();
                    try {
                        jSONObject.put("messageType", "htmlLoaded");
                        jSONObject.put("id", this.zzGC.zzGA.zzGy.zzGu);
                        this.zzGC.zzGz.zzb("sendMessageToNativeJs", jSONObject);
                    } catch (Throwable e) {
            ...
            C13041(C13093 c13093, zzjb com_google_android_gms_internal_zzjb) {
                this.zzGA = c13093;
            ...
            public void zza(zzqp com_google_android_gms_internal_zzqp, Map<String, String> map) {
                this.zzGA.zzGy.zzGt.zzkV().zza(new C13031(this, map));
        ...
        class C13052 implements zzhx {
            final /* synthetic */ C13093 zzGA;

            C13052(C13093 c13093) {
                this.zzGA = c13093;
            }
        ...
        class C13063 implements zzhx {
            final /* synthetic */ C13093 zzGA;

            C13063(C13093 c13093) {
                this.zzGA = c13093;
            }
        ...
        class C13074 implements zzhx {
            final /* synthetic */ C13093 zzGA;

            C13074(C13093 c13093) {
                this.zzGA = c13093;
            }
        ...
        /* renamed from: com.google.android.gms.internal.zzgv.3.5 */
        class C13085 implements zzhx {
            final /* synthetic */ C13093 zzGA;
            final /* synthetic */ zzjb zzGz;

            C13085(C13093 c13093, zzjb com_google_android_gms_internal_zzjb) {
                this.zzGA = c13093;
                this.zzGz = com_google_android_gms_internal_zzjb;
            }
            ...
            public void zza(zzqp com_google_android_gms_internal_zzqp, Map<String, String> map) {
                ...
                try {
                    ...
                    this.zzGz.zzb("sendMessageToNativeJs", jSONObject);
                } catch (Throwable e) {
                    zzpy.zzb("Unable to dispatch sendMessageToNativeJs event", e);
                }
            }
        ...
        C13093(zzgv com_google_android_gms_internal_zzgv) {
            this.zzGy = com_google_android_gms_internal_zzgv;
        }

        public void zze(zzjb com_google_android_gms_internal_zzjb) {
            com_google_android_gms_internal_zzjb.zza("/loadHtml", new C13041(this, com_google_android_gms_internal_zzjb));
            com_google_android_gms_internal_zzjb.zza("/showOverlay", new C13052(this));
            com_google_android_gms_internal_zzjb.zza("/hideOverlay", new C13063(this));
            this.zzGy.zzGt.zzkV().zza("/hideOverlay", new C13074(this));
            this.zzGy.zzGt.zzkV().zza("/sendMessageToSdk", new C13085(this, com_google_android_gms_internal_zzjb));
        }
    }
    ...
    public void zza(View view, String str, @Nullable JSONObject jSONObject, Map<String, WeakReference<View>> map, View view2) {
        ...
        try {
            ...
            this.zzGp.zza(new C13011(this, jSONObject3));
        } catch (Throwable e2) {
    ...
    public void zzb(View view, Map<String, WeakReference<View>> map) {
        ...
        try {
            ...
            this.zzGp.zza(new C13022(this, jSONObject));
        } catch (Throwable e) {
