...
public final class zzkd implements NativeMediationAdRequest {
    ...
    public zzkd(@Nullable Date date, int i, @Nullable Set<String> set, @Nullable Location location, boolean z, int i2, zzgw com_google_android_gms_internal_zzgw, List<String> list, boolean z2) {
        this.zzcQ = date;
        this.zzyW = i;
        this.zzcS = set;
        this.zzcU = location;
