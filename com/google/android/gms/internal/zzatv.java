...
public class zzatv extends zzats {
    ...
    class C09531 implements Runnable {
        ...
        C09531(zzatv com_google_android_gms_internal_zzatv, boolean z, zza com_google_android_gms_internal_zzatv_zza) {
    ...
    class C09542 implements Runnable {
        ...
        C09542(zzatv com_google_android_gms_internal_zzatv, zza com_google_android_gms_internal_zzatv_zza) {
            this.zzbuw = com_google_android_gms_internal_zzatv;
    ...
    private void zza(Activity activity, zza com_google_android_gms_internal_zzatv_zza, boolean z) {
        ...
        if (i != 0) {
            ...
            zzJs().zzm(new C09531(this, z, com_google_android_gms_internal_zzatv_zza2));
        }
    }
