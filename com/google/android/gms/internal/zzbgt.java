...
public class zzbgt extends zzbhc<zzbgy> {
    ...
    private Landmark zza(zzbha com_google_android_gms_internal_zzbha) {
        return new Landmark(new PointF(com_google_android_gms_internal_zzbha.f18x, com_google_android_gms_internal_zzbha.f19y), com_google_android_gms_internal_zzbha.type);
    }
