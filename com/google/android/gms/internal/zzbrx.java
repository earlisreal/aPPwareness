...
public final class zzbrx extends zzbrr {
    private static final Class<?>[] zzcmN;
    private Object value;

    static {
        zzcmN = new Class[]{Integer.TYPE, Long.TYPE, Short.TYPE, Float.TYPE, Double.TYPE, Byte.TYPE, Boolean.TYPE, Character.TYPE, Integer.class, Long.class, Short.class, Float.class, Double.class, Byte.class, Boolean.class, Character.class};
    }
