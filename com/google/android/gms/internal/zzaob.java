...
public interface zzaob extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaob {

        private static class zza implements zzaob {
        ...
        public static zzaob zzcs(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.fitness.internal.IDataTypeCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzaob)) ? new zza(iBinder) : (zzaob) queryLocalInterface;
        }
