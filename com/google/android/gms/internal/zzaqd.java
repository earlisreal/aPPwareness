...
public interface zzaqd extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaqd {
        ...
        private static class zza implements zzaqd {
            ...
            public void zza(zzaqc com_google_android_gms_internal_zzaqc, UserAddressRequest userAddressRequest, Bundle bundle) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.identity.intents.internal.IAddressService");
                    obtain.writeStrongBinder(com_google_android_gms_internal_zzaqc != null ? com_google_android_gms_internal_zzaqc.asBinder() : null);
        ...
        public static zzaqd zzcY(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case ChannelListener.CLOSE_REASON_REMOTE_CLOSE /*2*/:
                    ...
                    zza(com.google.android.gms.internal.zzaqc.zza.zzcX(parcel.readStrongBinder()), parcel.readInt() != 0 ? (UserAddressRequest) UserAddressRequest.CREATOR.createFromParcel(parcel) : null, parcel.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(parcel) : null);
    ...
    void zza(zzaqc com_google_android_gms_internal_zzaqc, UserAddressRequest userAddressRequest, Bundle bundle) throws RemoteException;
}
