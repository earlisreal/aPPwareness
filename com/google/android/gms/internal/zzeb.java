...
public class zzeb {
    ...
    public zznx zza(Context context, zzey com_google_android_gms_internal_zzey, String str) {
        return new zznx(zza(context, com_google_android_gms_internal_zzey), str);
    }
}
