...
public class zzast extends zzatr {
    ...
    static {
        zzbqo = String.valueOf(zzc.GOOGLE_PLAY_SERVICES_VERSION_CODE / CardNetwork.OTHER).replaceAll("(\\d+)(\\d)(\\d\\d)", "$1.$2.$3");
    }
    ...
    public String zzO(String str, String str2) {
        ...
        encodedAuthority.path(valueOf.length() != 0 ? str3.concat(valueOf) : new String(str3)).appendQueryParameter("app_instance_id", str2).appendQueryParameter("platform", SystemMediaRouteProvider.PACKAGE_NAME).appendQueryParameter("gmp_version", String.valueOf(10084));
    ...
    Boolean zzft(@Size(min = 1) String str) {
        ...
        try {
            if (getContext().getPackageManager() == null) {
                ...
                ApplicationInfo applicationInfo = zzacx.zzaQ(getContext()).getApplicationInfo(getContext().getPackageName(), Cast.MAX_NAMESPACE_LENGTH);
