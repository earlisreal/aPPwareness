...
public class zzaph {
    private static final ThreadLocal<String> zzaUM;

    static {
        zzaUM = new ThreadLocal();
    }

    public static boolean zzBV() {
        String str = (String) zzaUM.get();
        return str == null || str.startsWith(GoogleAuthUtil.GOOGLE_ACCOUNT_TYPE);
    }

    public static String zzK(String str, String str2) {
        ...
        return Integer.toHexString(zza(obj, 0, obj.length, 0));
    }

    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static int zza(byte[] r6, int r7, int r8, int r9) {
        /*
    ...
    L_0x006b:
        ...
        goto L_0x0047;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.zzaph.zza(byte[], int, int, int):int");
    }

    public static String zzeo(String str) {
        return zzBV() ? str : zzK(str, (String) zzaUM.get());
    }
}
