...
public class zzrz extends zzru {
    ...
    class C15111 extends zzsl {
        final /* synthetic */ zzrz zzado;

        C15111(zzrz com_google_android_gms_internal_zzrz, zzrw com_google_android_gms_internal_zzrw) {
    ...
    protected class zza implements ServiceConnection {
        ...
        /* renamed from: com.google.android.gms.internal.zzrz.zza.1 */
        class C15121 implements Runnable {
            final /* synthetic */ zzsu zzadr;
            final /* synthetic */ zza zzads;

            C15121(zza com_google_android_gms_internal_zzrz_zza, zzsu com_google_android_gms_internal_zzsu) {
                this.zzads = com_google_android_gms_internal_zzrz_zza;
                this.zzadr = com_google_android_gms_internal_zzsu;
            }

            public void run() {
                if (!this.zzads.zzado.isConnected()) {
                    this.zzads.zzado.zzbP("Connected to service after a timeout");
                    this.zzads.zzado.zza(this.zzadr);
                }
            }
        }

        /* renamed from: com.google.android.gms.internal.zzrz.zza.2 */
        class C15132 implements Runnable {
            final /* synthetic */ ComponentName val$name;
            final /* synthetic */ zza zzads;

            C15132(zza com_google_android_gms_internal_zzrz_zza, ComponentName componentName) {
                this.zzads = com_google_android_gms_internal_zzrz_zza;
                this.val$name = componentName;
            }

            public void run() {
                this.zzads.zzado.onServiceDisconnected(this.val$name);
            }
        }
...
*/
        ...
        public void onServiceDisconnected(ComponentName componentName) {
            ...
            this.zzado.zznt().zzg(new C15132(this, componentName));
        }
    ...
    protected zzrz(zzrw com_google_android_gms_internal_zzrw) {
        ...
        this.zzadk = new zza(this);
        this.zzadm = new C15111(this, com_google_android_gms_internal_zzrw);
    }
