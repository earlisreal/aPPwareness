...
public interface zzaqc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaqc {

        private static class zza implements zzaqc {
        ...
        public static zzaqc zzcX(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzaqc)) ? new zza(iBinder) : (zzaqc) queryLocalInterface;
        }
