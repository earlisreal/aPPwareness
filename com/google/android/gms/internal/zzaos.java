...
public interface zzaos extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaos {
        ...
        private static class zza implements zzaos {
        ...
        public static zzaos zzcJ(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.fitness.internal.IStatusCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzaos)) ? new zza(iBinder) : (zzaos) queryLocalInterface;
        }
