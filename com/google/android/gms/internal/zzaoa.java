...
public interface zzaoa extends IInterface {

    public static abstract class zza extends Binder implements zzaoa {

        private static class zza implements zzaoa {
        ...
        public static zzaoa zzcr(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.fitness.internal.IDataSourcesCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzaoa)) ? new zza(iBinder) : (zzaoa) queryLocalInterface;
        }
