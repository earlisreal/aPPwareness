...
public interface zzavv extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzavv {

        private static class zza implements zzavv {
        ...
        public static zzavv zzeJ(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.panorama.internal.IPanoramaCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzavv)) ? new zza(iBinder) : (zzavv) queryLocalInterface;
        }
