...
public class zzde {
    ...
    class C12701 implements Comparator<com.google.android.gms.internal.zzdh.zza> {
        C12701(zzde com_google_android_gms_internal_zzde) {
        }
    ...
    static class zza {
        ...
        public zza() {
            this.zzyg = new ByteArrayOutputStream(Connections.MAX_RELIABLE_MESSAGE_LEN);
    ...
    String zzG(String str) {
        ...
        zza zzep = zzep();
        PriorityQueue priorityQueue = new PriorityQueue(this.zzyd, new C12701(this));
