...
class zzsz extends zzru {
    ...
    private class zza {
        private ByteArrayOutputStream zzafA;
        ...
        public zza(zzsz com_google_android_gms_internal_zzsz) {
            ...
            this.zzafA = new ByteArrayOutputStream();
        }
    ...
    zzsz(zzrw com_google_android_gms_internal_zzrw) {
        ...
        this.zzHY = zza("GoogleAnalytics", zzrv.VERSION, VERSION.RELEASE, zztg.zza(Locale.getDefault()), Build.MODEL, Build.ID);
