...
public class zzav {
    private static final String[] zzqf;
    private String zzqb;
    private String zzqc;
    private String zzqd;
    private String[] zzqe;
    ...
    static {
        zzqf = new String[]{"/aclk", "/pcs/click"};
    }

    public zzav(zzaq com_google_android_gms_internal_zzaq) {
        this.zzqb = "googleads.g.doubleclick.net";
        this.zzqc = "/pagead/ads";
        this.zzqd = "ad.doubleclick.net";
        this.zzqe = new String[]{".doubleclick.net", ".googleadservices.com", ".googlesyndication.com"};
