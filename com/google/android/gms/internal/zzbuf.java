...
public final class zzbuf extends zzbun<zzbuf> {
    public int zzcqk;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof zzbuf)) {
            return false;
        }
        zzbuf com_google_android_gms_internal_zzbuf = (zzbuf) obj;
        return this.zzcqk == com_google_android_gms_internal_zzbuf.zzcqk ? (this.zzcrX == null || this.zzcrX.isEmpty()) ? com_google_android_gms_internal_zzbuf.zzcrX == null || com_google_android_gms_internal_zzbuf.zzcrX.isEmpty() : this.zzcrX.equals(com_google_android_gms_internal_zzbuf.zzcrX) : false;
    }
    ...
    public zzbuf zzaG(zzbul com_google_android_gms_internal_zzbul) throws IOException {
        while (true) {
