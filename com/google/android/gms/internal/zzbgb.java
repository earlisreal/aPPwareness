...
public final class zzbgb extends zzbfw<List<zzbfw<?>>> {
    ...
    class C10601 implements Iterator<zzbfw<?>> {
        private int zzbKZ;
        final /* synthetic */ zzbgb zzbLa;

        C10601(zzbgb com_google_android_gms_internal_zzbgb) {
    ...
    class C10612 implements Iterator<zzbfw<?>> {
        final /* synthetic */ Iterator zzbLb;
        final /* synthetic */ Iterator zzbLc;

        C10612(zzbgb com_google_android_gms_internal_zzbgb, Iterator it, Iterator it2) {
            this.zzbLb = it;
            this.zzbLc = it2;
        }
    ...
    public Iterator<zzbfw<?>> zzRE() {
        return new C10612(this, new C10601(this), super.zzRG());
    }
