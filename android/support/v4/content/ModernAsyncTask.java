...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    static class C00791 implements ThreadFactory {
    ...
    class C00813 extends FutureTask<Result> {
        C00813(Callable x0) {
            super(x0);
        }
    ...
    public ModernAsyncTask() {
        ...
        this.mWorker = new C00802();
        this.mFuture = new C00813(this.mWorker);
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
        if (this.mStatus != Status.PENDING) {
            switch (C00824.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {
