...
public abstract class AbsSavedState implements Parcelable {
    ...
    static class C01431 extends AbsSavedState {
        C01431() {
            super();
        }
    }
    ...
    static class C01442 implements ParcelableCompatCreatorCallbacks<AbsSavedState> {
        C01442() {
        }
    ...
    static {
        EMPTY_STATE = new C01431();
        CREATOR = ParcelableCompat.newCreator(new C01442());
    }
