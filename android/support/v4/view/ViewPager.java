...
public class ViewPager extends ViewGroup {
    ...
    static class C01551 implements Comparator<ItemInfo> {
        C01551() {
        }
    ...
    class C01584 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect;
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C01591 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C01591() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C01591());
        }
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C01551();
        sInterpolator = new C01562();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C01573();
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C01584());
    }
        ...
        for (i = SCROLL_STATE_IDLE; i < size; i += SCROLL_STATE_DRAGGING) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (lp != null && lp.isDecor) {
                    ...
                    int vgrav = lp.gravity & C0394R.styleable.AppCompatTheme_spinnerStyle;
