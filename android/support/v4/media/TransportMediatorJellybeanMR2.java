...
class TransportMediatorJellybeanMR2 {
    ...
    class C01141 implements OnWindowAttachListener {
        C01141() {
        }
    ...
    class C01152 implements OnWindowFocusChangeListener {
        C01152() {
        }
    ...
    class C01163 extends BroadcastReceiver {
        C01163() {
        }
    ...
    class C01174 implements OnAudioFocusChangeListener {
        C01174() {
        }
    ...
    class C01185 implements OnGetPlaybackPositionListener {
        C01185() {
        }
    ...
    class C01196 implements OnPlaybackPositionUpdateListener {
        C01196() {
        }
    ...
    public TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportCallback) {
        this.mWindowAttachListener = new C01141();
        this.mWindowFocusListener = new C01152();
        this.mMediaButtonReceiver = new C01163();
        this.mAudioFocusChangeListener = new C01174();
        this.mGetPlaybackPositionListener = new C01185();
        this.mPlaybackPositionUpdateListener = new C01196();
        this.mPlayState = 0;
