...
public class TransportMediator extends TransportController {
    ...
    class C01121 implements TransportMediatorCallback {
        C01121() {
        }
    ...
    class C01132 implements Callback {
        C01132() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C01121();
        this.mKeyEventCallback = new C01132();
