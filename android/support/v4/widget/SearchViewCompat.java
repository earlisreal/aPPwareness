...
public final class SearchViewCompat {
    ...
    static class SearchViewCompatHoneycombImpl extends SearchViewCompatStubImpl {
        ...
        class C01801 implements OnQueryTextListenerCompatBridge {
            final /* synthetic */ OnQueryTextListener val$listener;

            C01801(OnQueryTextListener onQueryTextListener) {
        ...
        class C01812 implements OnCloseListenerCompatBridge {
            final /* synthetic */ OnCloseListener val$listener;

            C01812(OnCloseListener onCloseListener) {
        ...
        public Object newOnQueryTextListener(OnQueryTextListener listener) {
            return SearchViewCompatHoneycomb.newOnQueryTextListener(new C01801(listener));
        }
        ...
        public Object newOnCloseListener(OnCloseListener listener) {
            return SearchViewCompatHoneycomb.newOnCloseListener(new C01812(listener));
        }
