...
class SearchViewCompatHoneycomb {
    ...
    static class C01821 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C01821(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C01832 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C01832(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
