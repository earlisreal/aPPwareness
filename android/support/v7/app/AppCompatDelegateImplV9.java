...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements Callback, LayoutInflaterFactory {
    ...
    class C02071 implements Runnable {
        ...
        public void run() {
            ...
            if ((AppCompatDelegateImplV9.this.mInvalidatePanelMenuFeatures & Connections.MAX_RELIABLE_MESSAGE_LEN) != 0) {
                AppCompatDelegateImplV9.this.doInvalidatePanelMenu(C0394R.styleable.AppCompatTheme_ratingBarStyle);
            }
    ...
    class C02082 implements OnApplyWindowInsetsListener {
        C02082() {
        }
    ...
    class C02093 implements OnFitSystemWindowsListener {
        C02093() {
        }
    ...
    class C02104 implements OnAttachListener {
        C02104() {
        }
    ...
    class C02125 implements Runnable {
        ...
        public void run() {
            ...
            if (AppCompatDelegateImplV9.this.shouldAnimateActionModeView()) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C02111());
                return;
            }
            ViewCompat.setAlpha(AppCompatDelegateImplV9.this.mActionModeView, TextTrackStyle.DEFAULT_FONT_SCALE);
            AppCompatDelegateImplV9.this.mActionModeView.setVisibility(0);
    ...
    class C02136 extends ViewPropertyAnimatorListenerAdapter {
        C02136() {
        }
    ...
    private final class ActionMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public boolean onOpenSubMenu(MenuBuilder subMenu) {
            ...
            if (cb != null) {
                cb.onMenuOpened(C0394R.styleable.AppCompatTheme_ratingBarStyle, subMenu);
            }
            return true;
        }
    ...
    class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            if (AppCompatDelegateImplV9.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C02141());
            }
    ...
    protected static final class PanelFeatureState {
        ...
        private static class SavedState implements Parcelable {
            ...
            static {
                CREATOR = ParcelableCompat.newCreator(new C02151());
            }
        }
        ...
        void setStyle(Context context) {
            ...
            TypedArray a = context2.obtainStyledAttributes(C0236R.styleable.AppCompatTheme);
            this.background = a.getResourceId(C0236R.styleable.AppCompatTheme_panelBackground, 0);
            this.windowAnimations = a.getResourceId(C0236R.styleable.AppCompatTheme_android_windowAnimationStyle, 0);
            a.recycle();
        }
    ...
    AppCompatDelegateImplV9(Context context, Window window, AppCompatCallback callback) {
        ...
        this.mFadeAnim = null;
        this.mInvalidatePanelMenuRunnable = new C02071();
    }
        ...
        if (!this.mSubDecorInstalled) {
            ...
            if (!isDestroyed()) {
                if (st == null || st.menu == null) {
                    invalidatePanelMenu(C0394R.styleable.AppCompatTheme_ratingBarStyle);
                }
            }
        }
    }
    ...
    private ViewGroup createSubDecor() {
        TypedArray a = this.mContext.obtainStyledAttributes(C0236R.styleable.AppCompatTheme);
        if (a.hasValue(C0236R.styleable.AppCompatTheme_windowActionBar)) {
            if (a.getBoolean(C0236R.styleable.AppCompatTheme_windowNoTitle, false)) {
                requestWindowFeature(1);
            } else if (a.getBoolean(C0236R.styleable.AppCompatTheme_windowActionBar, false)) {
                requestWindowFeature(C0394R.styleable.AppCompatTheme_ratingBarStyle);
            }
            if (a.getBoolean(C0236R.styleable.AppCompatTheme_windowActionBarOverlay, false)) {
                requestWindowFeature(C0394R.styleable.AppCompatTheme_ratingBarStyleIndicator);
            }
            if (a.getBoolean(C0236R.styleable.AppCompatTheme_windowActionModeOverlay, false)) {
                requestWindowFeature(10);
            }
            this.mIsFloating = a.getBoolean(C0236R.styleable.AppCompatTheme_android_windowIsFloating, false);
            a.recycle();
            ...
            if (this.mWindowNoTitle) {
                ...
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(subDecor, new C02082());
                } else {
                    ((FitWindowsViewGroup) subDecor).setOnFitSystemWindowsListener(new C02093());
                }
                ...
                this.mDecorContentParent = (DecorContentParent) subDecor.findViewById(C0236R.id.decor_content_parent);
                this.mDecorContentParent.setWindowCallback(getWindowCallback());
                if (this.mOverlayActionBar) {
                    this.mDecorContentParent.initFeature(C0394R.styleable.AppCompatTheme_ratingBarStyleIndicator);
                }
            ...
            if (this.mDecorContentParent == null) {
                this.mTitleView = (TextView) subDecor.findViewById(C0236R.id.title);
            }
            ViewUtils.makeOptionalFitsSystemWindows(subDecor);
            ContentFrameLayout contentView = (ContentFrameLayout) subDecor.findViewById(C0236R.id.action_bar_activity_content);
            ...
            contentView.setAttachListener(new C02104());
            return subDecor;
        }
        a.recycle();
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(C0236R.styleable.AppCompatTheme);
        a.getValue(C0236R.styleable.AppCompatTheme_windowMinWidthMajor, cfl.getMinWidthMajor());
        a.getValue(C0236R.styleable.AppCompatTheme_windowMinWidthMinor, cfl.getMinWidthMinor());
        if (a.hasValue(C0236R.styleable.AppCompatTheme_windowFixedWidthMajor)) {
            a.getValue(C0236R.styleable.AppCompatTheme_windowFixedWidthMajor, cfl.getFixedWidthMajor());
        }
        if (a.hasValue(C0236R.styleable.AppCompatTheme_windowFixedWidthMinor)) {
            a.getValue(C0236R.styleable.AppCompatTheme_windowFixedWidthMinor, cfl.getFixedWidthMinor());
        }
        if (a.hasValue(C0236R.styleable.AppCompatTheme_windowFixedHeightMajor)) {
            a.getValue(C0236R.styleable.AppCompatTheme_windowFixedHeightMajor, cfl.getFixedHeightMajor());
        }
        if (a.hasValue(C0236R.styleable.AppCompatTheme_windowFixedHeightMinor)) {
            a.getValue(C0236R.styleable.AppCompatTheme_windowFixedHeightMinor, cfl.getFixedHeightMinor());
        }
        a.recycle();
        cfl.requestLayout();
    }
    ...
    public boolean requestWindowFeature(int featureId) {
        ...
        if (this.mWindowNoTitle && featureId == C0394R.styleable.AppCompatTheme_ratingBarStyle) {
            return false;
        }
        ...
        switch (featureId) {
            ...
            case ConnectionResult.DEVELOPER_ERROR /*10*/:
                ...
                return true;
            case C0394R.styleable.AppCompatTheme_ratingBarStyle /*108*/:
                throwFeatureRequestIfSubDecorInstalled();
                this.mHasActionBar = true;
                return true;
            case C0394R.styleable.AppCompatTheme_ratingBarStyleIndicator /*109*/:
                throwFeatureRequestIfSubDecorInstalled();
    ...
    void onPanelClosed(int featureId, Menu menu) {
        if (featureId == C0394R.styleable.AppCompatTheme_ratingBarStyle) {
            ActionBar ab = getSupportActionBar();
            if (ab != null) {
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    this.mShowActionModePopup = new C02125();
                } else {
                    ViewStubCompat stub = (ViewStubCompat) this.mSubDecor.findViewById(C0236R.id.action_mode_bar_stub);
                    if (stub != null) {
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode, mode.getMenu())) {
                    ...
                    if (shouldAnimateActionModeView()) {
                        ...
                        this.mFadeAnim.setListener(new C02136());
                    } else {
    ...
    private void reopenMenu(MenuBuilder menu, boolean toggleMenuMode) {
        ...
        if (this.mDecorContentParent.isOverflowMenuShowing() && toggleMenuMode) {
            ...
            if (!isDestroyed()) {
                cb.onPanelClosed(C0394R.styleable.AppCompatTheme_ratingBarStyle, getPanelState(0, true).menu);
            }
            ...
            if (st.menu != null && !st.refreshMenuContent && cb.onPreparePanel(0, st.createdPanelView, st.menu)) {
                cb.onMenuOpened(C0394R.styleable.AppCompatTheme_ratingBarStyle, st.menu);
    ...
    private boolean initializePanelMenu(PanelFeatureState st) {
        Context context = this.mContext;
        if ((st.featureId == 0 || st.featureId == C0394R.styleable.AppCompatTheme_ratingBarStyle) && this.mDecorContentParent != null) {
            TypedValue outValue = new TypedValue();
    ...
    private boolean preparePanel(PanelFeatureState st, KeyEvent event) {
        ...
        if (st.featureId == 0 || st.featureId == C0394R.styleable.AppCompatTheme_ratingBarStyle) {
    ...
    void checkCloseActionMenu(MenuBuilder menu) {
        if (!this.mClosingActionMenu) {
            ...
            Window.Callback cb = getWindowCallback();
            if (!(cb == null || isDestroyed())) {
                cb.onPanelClosed(C0394R.styleable.AppCompatTheme_ratingBarStyle, menu);
            }
    ...
    void doInvalidatePanelMenu(int featureId) {
        ...
        st.refreshDecorView = true;
        if ((featureId == C0394R.styleable.AppCompatTheme_ratingBarStyle || featureId == 0) && this.mDecorContentParent != null) {
    ...
    private int sanitizeWindowFeatureId(int featureId) {
        if (featureId == 8) {
            ...
            return C0394R.styleable.AppCompatTheme_ratingBarStyle;
        } else if (featureId != 9) {
            return featureId;
        } else {
            Log.i("AppCompatDelegate", "You should now use the AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR_OVERLAY id when requesting this feature.");
            return C0394R.styleable.AppCompatTheme_ratingBarStyleIndicator;
        }
    }
