...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    class C02331 extends ViewPropertyAnimatorListenerAdapter {
        C02331() {
        }
    ...
    class C02342 extends ViewPropertyAnimatorListenerAdapter {
        C02342() {
        }
    ...
    class C02353 implements ViewPropertyAnimatorUpdateListener {
        C02353() {
        }
    ...
    public WindowDecorActionBar(Activity activity, boolean overlayMode) {
        ...
        this.mHideListener = new C02331();
        this.mShowListener = new C02342();
        this.mUpdateListener = new C02353();
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0236R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0236R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0236R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0236R.id.action_bar_container);
        ...
        if (a.getBoolean(C0236R.styleable.ActionBar_hideOnContentScroll, ALLOW_SHOW_HIDE_ANIMATIONS)) {
