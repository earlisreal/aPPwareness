...
abstract class AppCompatDelegateImplBase extends AppCompatDelegate {
    ...
    static class C02051 implements UncaughtExceptionHandler {
        final /* synthetic */ UncaughtExceptionHandler val$defHandler;

        C02051(UncaughtExceptionHandler uncaughtExceptionHandler) {
    ...
    static {
        ...
        if (SHOULD_INSTALL_EXCEPTION_HANDLER && !sInstalledExceptionHandler) {
            Thread.setDefaultUncaughtExceptionHandler(new C02051(Thread.getDefaultUncaughtExceptionHandler()));
