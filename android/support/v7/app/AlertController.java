...
class AlertController {
    ...
    class C01972 implements OnScrollChangeListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C01972(View view, View view2) {
            this.val$top = view;
    ...
    class C01994 implements OnScrollListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C01994(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    public static class AlertParams {
        ...
        class C02011 extends ArrayAdapter<CharSequence> {
            final /* synthetic */ ListView val$listView;

            C02011(Context x0, int x1, int x2, CharSequence[] x3, ListView listView) {
        ...
        class C02022 extends CursorAdapter {
            private final int mIsCheckedIndex;
            private final int mLabelIndex;
            final /* synthetic */ AlertController val$dialog;
            final /* synthetic */ ListView val$listView;

            C02022(Context x0, Cursor x1, boolean x2, ListView listView, AlertController alertController) {
                this.val$listView = listView;
        ...
        class C02033 implements OnItemClickListener {
            ...
            C02033(AlertController alertController) {
                this.val$dialog = alertController;
            }
        ...
        class C02044 implements OnItemClickListener {
            final /* synthetic */ AlertController val$dialog;
            final /* synthetic */ ListView val$listView;

            C02044(ListView listView, AlertController alertController) {
                this.val$listView = listView;
                this.val$dialog = alertController;
            }
        ...
        private void createListView(AlertController dialog) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                adapter = new C02011(this.mContext, dialog.mMultiChoiceItemLayout, 16908308, this.mItems, listView);
            } else {
                ListAdapter c02022 = new C02022(this.mContext, this.mCursor, false, listView, dialog);
            }
            ...
            if (this.mOnClickListener != null) {
                listView.setOnItemClickListener(new C02033(dialog));
            } else if (this.mOnCheckboxClickListener != null) {
                listView.setOnItemClickListener(new C02044(listView, dialog));
            }
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        this.mButtonHandler = new C01961();
        this.mContext = context;
        this.mDialog = di;
        this.mWindow = window;
    ...
    private void setupView() {
        View parentPanel = this.mWindow.findViewById(C0236R.id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0236R.id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0236R.id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0236R.id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0236R.id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0236R.id.topPanel);
        View customContentPanel = customPanel.findViewById(C0236R.id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0236R.id.buttonPanel);
        ...
        if (!(hasButtonPanel || contentPanel == null)) {
            View spacer = contentPanel.findViewById(C0236R.id.textSpacerNoButtons);
            if (spacer != null) {
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0236R.id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0236R.id.scrollIndicatorDown);
        ...
        if (indicatorUp != null || indicatorDown != null) {
            ...
            if (this.mMessage != null) {
                this.mScrollView.setOnScrollChangeListener(new C01972(top, bottom));
                this.mScrollView.post(new C01983(top, bottom));
            } else if (this.mListView != null) {
                this.mListView.setOnScrollListener(new C01994(top, bottom));
                this.mListView.post(new C02005(top, bottom));
            } else {
                if (top != null) {
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0236R.id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        ...
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0236R.id.title_template).setVisibility(8);
            return;
        }
        ...
        if (hasTextTitle) {
            this.mTitleView = (TextView) this.mWindow.findViewById(C0236R.id.alertTitle);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0236R.id.scrollView);
