...
public final class MediaItemStatus {
    ...
    public static final class Builder {
        ...
        public MediaItemStatus build() {
            return new MediaItemStatus(null);
        }
    }
    ...
    public int getPlaybackState() {
        return this.mBundle.getInt(KEY_PLAYBACK_STATE, PLAYBACK_STATE_ERROR);
    }
    ...
    private static String playbackStateToString(int playbackState) {
        switch (playbackState) {
            case PLAYBACK_STATE_PENDING /*0*/:
                return "pending";
            case PLAYBACK_STATE_PLAYING /*1*/:
                return "playing";
            case PLAYBACK_STATE_PAUSED /*2*/:
                return "paused";
            case PLAYBACK_STATE_BUFFERING /*3*/:
                return "buffering";
            case PLAYBACK_STATE_FINISHED /*4*/:
                return "finished";
            case PLAYBACK_STATE_CANCELED /*5*/:
                return "canceled";
            case PLAYBACK_STATE_INVALIDATED /*6*/:
                return "invalidated";
            case PLAYBACK_STATE_ERROR /*7*/:
