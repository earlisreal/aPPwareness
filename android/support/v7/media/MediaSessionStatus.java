...
public final class MediaSessionStatus {
    ...
    public static final class Builder {
        ...
        public MediaSessionStatus build() {
            return new MediaSessionStatus(null);
        }
    }
    ...
    public int getSessionState() {
        return this.mBundle.getInt(KEY_SESSION_STATE, SESSION_STATE_INVALIDATED);
    }
    ...
    private static String sessionStateToString(int sessionState) {
        switch (sessionState) {
            case SESSION_STATE_ACTIVE /*0*/:
                return "active";
            case SESSION_STATE_ENDED /*1*/:
                return "ended";
            case SESSION_STATE_INVALIDATED /*2*/:
                return "invalidated";
            default:
