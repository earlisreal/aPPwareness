...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        setColor(a.getColor(C0236R.styleable.DrawerArrowToggle_color, ARROW_DIRECTION_LEFT));
        ...
        this.mSize = a.getDimensionPixelSize(C0236R.styleable.DrawerArrowToggle_drawableSize, ARROW_DIRECTION_LEFT);
