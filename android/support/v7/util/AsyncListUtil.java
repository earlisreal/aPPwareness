...
public class AsyncListUtil<T> {
    ...
    class C02621 implements MainThreadCallback<T> {
        C02621() {
        }
    ...
    class C02632 implements BackgroundCallback<T> {
    ...
    public AsyncListUtil(Class<T> klass, int tileSize, DataCallback<T> dataCallback, ViewCallback viewCallback) {
        ...
        this.mMainThreadCallback = new C02621();
        this.mBackgroundCallback = new C02632();
        this.mTClass = klass;
