...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    class C02671 implements MainThreadCallback<T> {
        ...
        class C02661 implements Runnable {
            ...
            public void run() {
                SyncQueueItem msg = C02671.this.mQueue.next();
                while (msg != null) {
                    switch (msg.what) {
                        case C02671.UPDATE_ITEM_COUNT /*1*/:
                            C02671.this.val$callback.updateItemCount(msg.arg1, msg.arg2);
                            break;
                        case C02671.ADD_TILE /*2*/:
                            C02671.this.val$callback.addTile(msg.arg1, (Tile) msg.data);
                            break;
                        case C02671.REMOVE_TILE /*3*/:
                            C02671.this.val$callback.removeTile(msg.arg1, msg.arg2);
                            break;
                        default:
                            Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                            break;
                    }
                    msg = C02671.this.mQueue.next();
                }
            }
        }

        C02671(MainThreadCallback mainThreadCallback) {
            this.val$callback = mainThreadCallback;
            this.mQueue = new MessageQueue();
            this.mMainThreadHandler = new Handler(Looper.getMainLooper());
            this.mMainThreadRunnable = new C02661();
        }
    ...
    class C02692 implements BackgroundCallback<T> {
        ...
        class C02681 implements Runnable {
            ...
            public void run() {
                while (true) {
                    SyncQueueItem msg = C02692.this.mQueue.next();
                    if (msg != null) {
                        switch (msg.what) {
                            case C02692.REFRESH /*1*/:
                                C02692.this.mQueue.removeMessages(C02692.REFRESH);
                                C02692.this.val$callback.refresh(msg.arg1);
                                break;
                            case C02692.UPDATE_RANGE /*2*/:
                                C02692.this.mQueue.removeMessages(C02692.UPDATE_RANGE);
                                C02692.this.mQueue.removeMessages(C02692.LOAD_TILE);
                                C02692.this.val$callback.updateRange(msg.arg1, msg.arg2, msg.arg3, msg.arg4, msg.arg5);
                                break;
                            case C02692.LOAD_TILE /*3*/:
                                C02692.this.val$callback.loadTile(msg.arg1, msg.arg2);
                                break;
                            case C02692.RECYCLE_TILE /*4*/:
                                C02692.this.val$callback.recycleTile((Tile) msg.data);
                                break;
                            default:
                                Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                                break;
                    ...
                    C02692.this.mBackgroundRunning.set(false);
                    return;
                }
            }
        }

        C02692(BackgroundCallback backgroundCallback) {
            ...
            this.mBackgroundRunnable = new C02681();
        }
