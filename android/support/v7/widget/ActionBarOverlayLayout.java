...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    static {
        ATTRS = new int[]{C0236R.attr.actionBarSize, 16842841};
    }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C02791();
        this.mRemoveActionBarHideOffset = new C02802();
        this.mAddActionBarHideOffset = new C02813();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0236R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0236R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0236R.id.action_bar));
        }
    }
    ...
    private boolean shouldHideActionBarOnFling(float velocityX, float velocityY) {
        this.mFlingEstimator.fling(0, 0, 0, (int) velocityY, 0, 0, RtlSpacingHelper.UNDEFINED, Strategy.TTL_SECONDS_INFINITE);
