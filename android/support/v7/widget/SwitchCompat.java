...
public class SwitchCompat extends CompoundButton {
    ...
    class C03341 implements AnimationListener {
    ...
    public SwitchCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ColorStateList thumbTintList = a.getColorStateList(C0236R.styleable.SwitchCompat_thumbTint);
        if (thumbTintList != null) {
            this.mThumbTintList = thumbTintList;
            this.mHasThumbTint = true;
        }
        Mode thumbTintMode = DrawableUtils.parseTintMode(a.getInt(C0236R.styleable.SwitchCompat_thumbTintMode, -1), null);
        ...
        ColorStateList trackTintList = a.getColorStateList(C0236R.styleable.SwitchCompat_trackTint);
        if (trackTintList != null) {
            this.mTrackTintList = trackTintList;
            this.mHasTrackTint = true;
        }
        Mode trackTintMode = DrawableUtils.parseTintMode(a.getInt(C0236R.styleable.SwitchCompat_trackTintMode, -1), null);
    ...
    private void animateThumbToCheckedState(boolean newCheckedState) {
        ...
        this.mPositionAnimator.setAnimationListener(new C03341(newCheckedState));
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        switch (getGravity() & C0394R.styleable.AppCompatTheme_spinnerStyle) {
