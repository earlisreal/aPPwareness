...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C02841 extends DataSetObserver {
        C02841() {
        }
    ...
    class C02852 implements OnGlobalLayoutListener {
        C02852() {
        }
    ...
    class C02874 extends DataSetObserver {
        C02874() {
        }
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            switch (getItemViewType(position)) {
                case ITEM_VIEW_TYPE_ACTIVITY /*0*/:
                    if (convertView == null || convertView.getId() != C0236R.id.list_item) {
                    ...
                    ((ImageView) convertView.findViewById(C0236R.id.icon)).setImageDrawable(activity.loadIcon(packageManager));
                    ((TextView) convertView.findViewById(C0236R.id.title)).setText(activity.loadLabel(packageManager));
                ...
                case ITEM_VIEW_TYPE_FOOTER /*1*/:
                    if (convertView == null || convertView.getId() != ITEM_VIEW_TYPE_FOOTER) {
                        ...
                        ((TextView) convertView.findViewById(C0236R.id.title)).setText(ActivityChooserView.this.getContext().getString(C0236R.string.abc_activity_chooser_view_see_all));
                    }
                    return convertView;
                default:
                    throw new IllegalArgumentException();
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mModelDataSetObserver = new C02841();
        this.mOnGlobalLayoutListener = new C02852();
        ...
        this.mActivityChooserContent = (LinearLayoutCompat) findViewById(C0236R.id.activity_chooser_view_content);
        this.mActivityChooserContentBackground = this.mActivityChooserContent.getBackground();
        this.mDefaultActivityButton = (FrameLayout) findViewById(C0236R.id.default_activity_button);
        this.mDefaultActivityButton.setOnClickListener(this.mCallbacks);
        this.mDefaultActivityButton.setOnLongClickListener(this.mCallbacks);
        this.mDefaultActivityButtonImage = (ImageView) this.mDefaultActivityButton.findViewById(C0236R.id.image);
        FrameLayout expandButton = (FrameLayout) findViewById(C0236R.id.expand_activities_button);
        ...
        this.mExpandActivityOverflowButtonImage = (ImageView) expandButton.findViewById(C0236R.id.image);
        ...
        this.mAdapter.registerDataSetObserver(new C02874());
