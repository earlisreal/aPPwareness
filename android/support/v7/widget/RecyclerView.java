...
import android.support.v7.recyclerview.C0261R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    public static abstract class LayoutManager {
        ...
        public static int getChildMeasureSpec(int parentSize, int parentMode, int padding, int childDimension, boolean canScroll) {
            ...
            if (childDimension >= 0) {
                ...
                resultSize = size;
                resultMode = (parentMode == RtlSpacingHelper.UNDEFINED || parentMode == 1073741824) ? RtlSpacingHelper.UNDEFINED : RecyclerView.TOUCH_SLOP_DEFAULT;
            }
            return MeasureSpec.makeMeasureSpec(resultSize, resultMode);
        }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0261R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0261R.styleable.RecyclerView_android_orientation, RecyclerView.VERTICAL);
            properties.spanCount = a.getInt(C0261R.styleable.RecyclerView_spanCount, RecyclerView.VERTICAL);
            properties.reverseLayout = a.getBoolean(C0261R.styleable.RecyclerView_reverseLayout, RecyclerView.FORCE_INVALIDATE_DISPLAY_LIST);
            properties.stackFromEnd = a.getBoolean(C0261R.styleable.RecyclerView_stackFromEnd, RecyclerView.FORCE_INVALIDATE_DISPLAY_LIST);
            a.recycle();
            return properties;
        }
    ...
    static class C03123 implements Interpolator {
        C03123() {
        }
    ...
    class C03134 implements ProcessCallback {
        C03134() {
        }
    ...
    class C03145 implements Callback {
        C03145() {
        }
    ...
    class C03156 implements Callback {
        C03156() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C03161());
        }
    }
    ...
    private class ViewFlinger implements Runnable {
        ...
        public void fling(int velocityX, int velocityY) {
            ...
            this.mScroller.fling(RecyclerView.TOUCH_SLOP_DEFAULT, RecyclerView.TOUCH_SLOP_DEFAULT, velocityX, velocityY, RtlSpacingHelper.UNDEFINED, Strategy.TTL_SECONDS_INFINITE, RtlSpacingHelper.UNDEFINED, Strategy.TTL_SECONDS_INFINITE);
            postOnAnimation();
        }
    ...
    static {
        ...
        sQuinticInterpolator = new C03123();
    }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C03101();
        ...
        this.mItemAnimatorRunner = new C03112();
        this.mViewInfoProcessCallback = new C03134();
        if (attrs != null) {
        ...
        if (attrs != null) {
            a = context.obtainStyledAttributes(attrs, C0261R.styleable.RecyclerView, defStyle, TOUCH_SLOP_DEFAULT);
            String layoutManagerName = a.getString(C0261R.styleable.RecyclerView_layoutManager);
            if (a.getInt(C0261R.styleable.RecyclerView_android_descendantFocusability, NO_POSITION) == NO_POSITION) {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C03145());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C03156());
    }
