...
public class PopupMenu {
    ...
    class C03082 implements android.widget.PopupWindow.OnDismissListener {
        C03082() {
        }
    ...
    class C03093 extends ForwardingListener {
        C03093(View src) {
            super(src);
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C03071());
        ...
        this.mPopup.setOnDismissListener(new C03082());
    }
    ...
    public OnTouchListener getDragToOpenListener() {
        if (this.mDragListener == null) {
            this.mDragListener = new C03093(this.mAnchor);
        }
