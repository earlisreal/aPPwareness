...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C03224 implements OnFocusChangeListener {
        C03224() {
        }
    ...
    class C03235 implements OnLayoutChangeListener {
        C03235() {
        }
    ...
    class C03246 implements OnGlobalLayoutListener {
        C03246() {
        }
    ...
    class C03257 implements OnClickListener {
        C03257() {
        }
    ...
    class C03268 implements OnKeyListener {
        C03268() {
        }
    ...
    class C03279 implements OnEditorActionListener {
        C03279() {
        }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mShowImeRunnable = new C03191();
        this.mUpdateDrawableStateRunnable = new C03202();
        this.mReleaseCursorRunnable = new C03213();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C03257();
        this.mTextKeyListener = new C03268();
        this.mOnEditorActionListener = new C03279();
        ...
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0236R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0236R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0236R.id.search_plate);
        this.mSubmitArea = findViewById(C0236R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0236R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0236R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0236R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0236R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0236R.id.search_mag_icon);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C03224());
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C03235());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C03246());
    }
    ...
    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0236R.dimen.abc_search_view_preferred_height);
    }
