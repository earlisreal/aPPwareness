...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    class C02891 extends ForwardingListener {
        final /* synthetic */ DropdownPopup val$popup;

        C02891(View src, DropdownPopup dropdownPopup) {
    ...
    private class DropdownPopup extends ListPopupWindow {
        ...
        class C02901 implements OnItemClickListener {
            final /* synthetic */ AppCompatSpinner val$this$0;

            C02901(AppCompatSpinner appCompatSpinner) {
        ...
        class C02912 implements OnGlobalLayoutListener {
            C02912() {
            }
        ...
        class C02923 implements OnDismissListener {
            final /* synthetic */ OnGlobalLayoutListener val$layoutListener;

            C02923(OnGlobalLayoutListener onGlobalLayoutListener) {
        ...
        public DropdownPopup(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            setOnItemClickListener(new C02901(AppCompatSpinner.this));
        }
        ...
        public void show() {
            ...
            if (!wasShowing) {
                ViewTreeObserver vto = AppCompatSpinner.this.getViewTreeObserver();
                if (vto != null) {
                    OnGlobalLayoutListener layoutListener = new C02912();
                    vto.addOnGlobalLayoutListener(layoutListener);
                    setOnDismissListener(new C02923(layoutListener));
                }
            }
        }
    ...
    public AppCompatSpinner(Context context, AttributeSet attrs, int defStyleAttr, int mode, Theme popupTheme) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0236R.styleable.Spinner, defStyleAttr, MODE_DIALOG);
        this.mBackgroundTintHelper = new AppCompatBackgroundHelper(this);
        if (popupTheme != null) {
            this.mPopupContext = new ContextThemeWrapper(context, popupTheme);
        } else {
            int popupThemeResId = a.getResourceId(C0236R.styleable.Spinner_popupTheme, MODE_DIALOG);
        ...
        if (this.mPopupContext != null) {
            ...
            if (mode == MODE_DROPDOWN) {
                ...
                TintTypedArray pa = TintTypedArray.obtainStyledAttributes(this.mPopupContext, attrs, C0236R.styleable.Spinner, defStyleAttr, MODE_DIALOG);
                ...
                pa.recycle();
                this.mPopup = popup;
                this.mForwardingListener = new C02891(this, popup);
            }
        }
        CharSequence[] entries = a.getTextArray(C0236R.styleable.Spinner_android_entries);
        if (entries != null) {
            SpinnerAdapter adapter = new ArrayAdapter(context, 17367048, entries);
            adapter.setDropDownViewResource(C0236R.layout.support_simple_spinner_dropdown_item);
            setAdapter(adapter);
        }
        a.recycle();
        this.mPopupSet = true;
