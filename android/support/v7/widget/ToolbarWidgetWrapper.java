...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    class C03402 extends ViewPropertyAnimatorListenerAdapter {
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean style) {
        this(toolbar, style, C0236R.string.abc_action_bar_up_description, C0236R.drawable.abc_ic_ab_back_material);
    }
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean style, int defaultNavigationContentDescription, int defaultNavigationIcon) {
        ...
        this.mDefaultNavigationIcon = a.getDrawable(C0236R.styleable.ActionBar_homeAsUpIndicator);
        if (style) {
        ...
        this.mToolbar.setNavigationOnClickListener(new C03391());
    }
    ...
    public void setMenu(Menu menu, MenuPresenter.Callback cb) {
        if (this.mActionMenuPresenter == null) {
            ...
            this.mActionMenuPresenter.setId(C0236R.id.action_menu_presenter);
        }
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(int visibility, long duration) {
        return ViewCompat.animate(this.mToolbar).alpha(visibility == 0 ? TextTrackStyle.DEFAULT_FONT_SCALE : 0.0f).setDuration(duration).setListener(new C03402(visibility));
    }
