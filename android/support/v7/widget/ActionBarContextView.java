...
public class ActionBarContextView extends AbsActionBarView {
    ...
    private void initTitle() {
        ...
        if (this.mTitleLayout == null) {
            ...
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0236R.id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0236R.id.action_bar_subtitle);
    ...
    public void initForMode(ActionMode mode) {
        ...
        this.mClose.findViewById(C0236R.id.action_mode_close_button).setOnClickListener(new C02781(mode));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (MeasureSpec.getMode(widthMeasureSpec) != 1073741824) {
            ...
            if (this.mCustomView != null) {
                ...
                int i = lp2.width;
                int customWidthMode = r0 != -2 ? 1073741824 : RtlSpacingHelper.UNDEFINED;
                if (lp2.width >= 0) {
                ...
                i = lp2.height;
                int customHeightMode = r0 != -2 ? 1073741824 : RtlSpacingHelper.UNDEFINED;
                if (lp2.height >= 0) {
