...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    class C00152 implements AnimatorUpdateListener {
        C00152() {
        }
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mCollapsingTextHelper.setCollapsedTextAppearance(C0236R.style.TextAppearance_AppCompat_Widget_ActionBar_Title);
    ...
    private void animateScrim(int targetAlpha) {
        ...
        if (this.mScrimAnimator == null) {
            ...
            this.mScrimAnimator.addUpdateListener(new C00152());
